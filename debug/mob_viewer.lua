...
_Debug.Mob.Rows = function(mob)
    ...
    UI.TableNextColumn() UI.Text(tostring(mob.id))
    UI.TableNextRow()
    ...
    UI.TableNextColumn() UI.Text(Col.String.Format_Number(mob.distance))
    UI.TableNextRow()
    UI.TableNextColumn() UI.Text("hpp")
    UI.TableNextColumn() UI.Text(tostring(mob.hpp))
    UI.TableNextRow()
    UI.TableNextColumn() UI.Text("x")
    UI.TableNextColumn() UI.Text(Col.String.Format_Number(mob.x))
    UI.TableNextRow()
    UI.TableNextColumn() UI.Text("y")
    UI.TableNextColumn() UI.Text(Col.String.Format_Number(mob.y))
    UI.TableNextRow()
    UI.TableNextColumn() UI.Text("z")
    UI.TableNextColumn() UI.Text(Col.String.Format_Number(mob.z))
    UI.TableNextRow()
