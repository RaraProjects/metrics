...
m.Enum.Pet_Single_Trackable = {
	...
	PET_NUKE       = m.Enum.Trackable.PET_NUKE,
	PET_ENFEEBLING = m.Enum.Trackable.PET_ENFEEBLING,
	PET_MP_DRAIN   = m.Enum.Trackable.PET_MP_DRAIN,
	PET_MAGIC      = m.Enum.Trackable.PET_MAGIC,
}
