...
Parse.Util.Calculate_Column_Flags = function()
    ...
    if Parse.Settings.Show_Total_Skillchain      then added_columns = added_columns + 1 end
    ...
    if Parse.Settings.Show_Total_Nuking          then added_columns = added_columns + 1 end
