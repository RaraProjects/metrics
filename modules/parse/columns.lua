...
table.insert(Parse.Column_Content, {
    ...
    Header    = function() return DB.DPS.Column_Header() end,
    Content   = function(player_name) Column.Attack_Speed.Get(player_name, true) end,
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Acc.By_Type(player_name, DB.Enum.COMBINED, nil, false, nil, true) end,
    Total     = function() UI.Text(" ") end,
    Is_Mini   = false,
    Is_Nano   = false,
})
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Acc.By_Type(player_name, DB.Enum.COMBINED, 0, true, nil, true) end,
    Total     = function() UI.Text(" ") end,
    Is_Mini   = false,
    Is_Nano   = false,
})
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type(player_name, DB.Trackable.MELEE_OVERALL, nil, nil, false, true) end,
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Acc.By_Type(player_name, DB.Trackable.MELEE_OVERALL, nil, false, nil, true) end,
    Total     = function() UI.Text(" ") end,
    Is_Mini   = false,
    Is_Nano   = false,
})
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Acc.By_Type(player_name, DB.Trackable.MELEE_OVERALL, 0, true, nil, true) end,
    Total     = function() UI.Text(" ") end,
    Is_Mini   = false,
    Is_Nano   = false,
})
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type(player_name, DB.Trackable.WEAPONSKILL, nil, nil, false, true) end,
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type_Average(player_name, DB.Trackable.WEAPONSKILL, nil, nil, true) end,
    Total     = function() UI.Text(" ") end,
    Is_Mini   = false,
    Is_Nano   = false,
})
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type(player_name, DB.Trackable.SKILLCHAIN, nil, nil, false, true) end,
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type(player_name, DB.Trackable.RANGED_OVERALL, nil, nil, false, true) end,
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Acc.By_Type(player_name, DB.Trackable.RANGED_OVERALL, nil, false, nil, true) end,
    Total     = function() UI.Text(" ") end,
    Is_Mini   = false,
    Is_Nano   = false,
})
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Acc.By_Type(player_name, DB.Trackable.RANGED_OVERALL, 0, true, nil, true) end,
    Total     = function() UI.Text(" ") end,
    Is_Mini   = false,
    Is_Nano   = false,
})
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type(player_name, DB.Trackable.SPELLS_NUKING, nil, nil, false, true) end,
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type(player_name, DB.Trackable.ABILITY_DAMAGING, nil, nil, false, true) end,
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type(player_name, DB.Trackable.PET_OVERALL, nil, nil, false, true) end,
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Acc.By_Type(player_name, DB.Trackable.PET_MELEE_DISCRETE, nil, false, nil, true) end,
    Total     = function() UI.Text(" ") end,
    Is_Mini   = true,
    Is_Nano   = false,
})
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type(player_name, DB.Trackable.PET_MELEE_OVERALL, nil, nil, false, true) end,
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type(player_name, DB.Trackable.PET_RANGED_OVERALL, nil, nil, false, true) end,
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type(player_name, DB.Trackable.PET_TP, nil, nil, false, true) end,
...
table.insert(Parse.Column_Content, {
    ...
    Content   = function(player_name) Column.Damage.By_Type(player_name, DB.Trackable.PET_HEALING, nil, nil, false, true) end,
