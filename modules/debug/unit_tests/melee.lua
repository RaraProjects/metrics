...
Debug.Unit.Tests.Melee.Pet_Hit = function()
    ...
    for _, target_index in ipairs(target_lists) do
        ...
        player[player_name][target_index][DB.Trackable.PET_MELEE_OVERALL][DB.Metric.HITS_ON_USE] = 1
        ...
        player[player_name][target_index][DB.Trackable.PET_MELEE_DISCRETE][DB.Metric.HITS_ON_USE] = 1
        ...
        pet[player_name][pet_name][target_index][DB.Trackable.PET_MELEE_OVERALL][DB.Metric.HITS_ON_USE] = 1
        ...
        pet[player_name][pet_name][target_index][DB.Trackable.PET_MELEE_DISCRETE][DB.Metric.HITS_ON_USE] = 1
...
Debug.Unit.Tests.Melee.Daken_Hit = function()
    ...
    for _, target_index in ipairs(target_lists) do
        ...
        player[player_name][target_index][DB.Trackable.RANGED_OVERALL][DB.Metric.HITS_ON_USE] = 1
...
Debug.Unit.Tests.Melee.Endebuff = function()
    ...
    for _, target_index in ipairs(target_lists) do
        ...
        player[player_name][target_index][DB.Trackable.MELEE_ENDEBUFF][DB.Metric.HITS_ON_USE] = 1
        ...
        player_catalog[player_name][target_index][add_effect_name][DB.Trackable.MELEE_ENDEBUFF][DB.Metric.HITS_ON_USE] = 1
...
Debug.Unit.Tests.Melee.Endrain = function()
    ...
    for _, target_index in ipairs(target_lists) do
        ...
        player[player_name][target_index][DB.Trackable.MELEE_ENDRAIN][DB.Metric.HITS_ON_USE] = 1
...
Debug.Unit.Tests.Melee.Enaspir = function()
    ...
    for _, target_index in ipairs(target_lists) do
        ...
        player[player_name][target_index][DB.Trackable.MELEE_ENASPIR][DB.Metric.HITS_ON_USE] = 1
