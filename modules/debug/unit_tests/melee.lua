...
Debug.Unit.Tests.Melee.Main_Hit = function()
    ...
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MIN] = damage
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MAX] = damage
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MELEE_ROUNDS] = 1
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN] = T{}
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MIN] = damage
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MAX] = damage
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MULTI_ATTACK_1] = 1
    player[index][DB.Enum.Trackable.MELEE_COUNTERED] = T{}
    player[index][DB.Enum.Trackable.MELEE_COUNTERED][DB.Metric.ATTEMPTS] = 1
...
Debug.Unit.Tests.Melee.Crit = function()
    ...
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MIN] = damage
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MAX] = damage
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.CRITICAL_DAMAGE] = damage
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.CRITICAL_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MELEE_ROUNDS] = 1
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MELEE_STRIKES] = 1
    ...
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MIN] = damage
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MAX] = damage
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.CRITICAL_DAMAGE] = damage
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.CRITICAL_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MULTI_ATTACK_1] = 1
...
Debug.Unit.Tests.Melee.Enspell = function()
    ...
    player[index][DB.Enum.Trackable.MAGIC][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.ENSPELL] = T{}
    player[index][DB.Enum.Trackable.ENSPELL][DB.Metric.TOTAL] = additional_damage
    player[index][DB.Enum.Trackable.ENSPELL][DB.Metric.MIN] = additional_damage
    player[index][DB.Enum.Trackable.ENSPELL][DB.Metric.MAX] = additional_damage
    player[index][DB.Enum.Trackable.ENSPELL][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.TOTAL] = T{}
    ...
    player_catalog[index][add_effect_name][DB.Enum.Trackable.ENSPELL][DB.Metric.TOTAL] = additional_damage
    player_catalog[index][add_effect_name][DB.Enum.Trackable.ENSPELL][DB.Metric.MIN] = additional_damage
    player_catalog[index][add_effect_name][DB.Enum.Trackable.ENSPELL][DB.Metric.MAX] = additional_damage
    player_catalog[index][add_effect_name][DB.Enum.Trackable.ENSPELL][DB.Metric.HIT_COUNT] = 1
...
Debug.Unit.Tests.Melee.Shadows = function()
    ...
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MELEE_ROUNDS] = 1
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.SHADOW_ABSORPTION] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN] = T{}
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.SHADOW_ABSORPTION] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MULTI_ATTACK_1] = 1
    player[index][DB.Enum.Trackable.MELEE_COUNTERED] = T{}
    player[index][DB.Enum.Trackable.MELEE_COUNTERED][DB.Metric.ATTEMPTS] = 1
...
Debug.Unit.Tests.Melee.Mob_Heal = function()
    ...
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MELEE_ROUNDS] = 1
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.MELEE][DB.Metric.MOB_HEALING] = damage
    player[index][DB.Enum.Trackable.MELEE_MAIN] = T{}
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MULTI_ATTACK_1] = 1
    player[index][DB.Enum.Trackable.MELEE_MAIN][DB.Metric.MOB_HEALING] = damage
    player[index][DB.Enum.Trackable.MELEE_COUNTERED] = T{}
    player[index][DB.Enum.Trackable.MELEE_COUNTERED][DB.Metric.ATTEMPTS] = 1
...
Debug.Unit.Tests.Melee.Off_Hand_Hit = function()
    ...
    player[index][DB.Enum.Trackable.MELEE_OFFHAND][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.MELEE_OFFHAND][DB.Metric.MIN] = damage
    player[index][DB.Enum.Trackable.MELEE_OFFHAND][DB.Metric.MAX] = damage
    player[index][DB.Enum.Trackable.MELEE_OFFHAND][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE_OFFHAND][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.MELEE_OFFHAND][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.MELEE_OFFHAND][DB.Metric.MULTI_ATTACK_1] = 1
    player[index][DB.Enum.Trackable.MELEE_COUNTERED] = T{}
    player[index][DB.Enum.Trackable.MELEE_COUNTERED][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.TOTAL] = T{}
    player[index][DB.Enum.Trackable.TOTAL][DB.Metric.TOTAL] = damage
...
Debug.Unit.Tests.Melee.Pet_Hit = function()
    ...
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.MIN] = damage
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.MAX] = damage
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE] = T{}
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.MIN] = damage
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.MAX] = damage
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.TOTAL] = T{}
    player[index][DB.Enum.Trackable.TOTAL][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.TOTAL_NO_SC] = T{}
    player[index][DB.Enum.Trackable.TOTAL_NO_SC][DB.Metric.TOTAL] = damage
    ...
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.TOTAL] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.MIN] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.MAX] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.HIT_COUNT] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.ATTEMPTS] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE] = T{}
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.TOTAL] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.MIN] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.MAX] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.HIT_COUNT] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.ATTEMPTS] = 1
...
Debug.Unit.Tests.Melee.Pet_Crit = function()
    ...
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.CRITICAL_DAMAGE] = damage
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.CRITICAL_COUNT] = 1
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE] = T{}
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.MIN] = damage
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.MAX] = damage
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.CRITICAL_DAMAGE] = damage
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.CRITICAL_COUNT] = 1
    player[index][DB.Enum.Trackable.TOTAL] = T{}
    player[index][DB.Enum.Trackable.TOTAL][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.TOTAL_NO_SC] = T{}
    player[index][DB.Enum.Trackable.TOTAL_NO_SC][DB.Metric.TOTAL] = damage
    ...
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.HIT_COUNT] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.ATTEMPTS] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.CRITICAL_DAMAGE] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.CRITICAL_COUNT] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE] = T{}
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.TOTAL] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.MIN] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.MAX] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.HIT_COUNT] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.ATTEMPTS] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.CRITICAL_DAMAGE] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.CRITICAL_COUNT] = 1
    pet[index][pet_name][DB.Enum.Trackable.TOTAL] = T{}
    pet[index][pet_name][DB.Enum.Trackable.TOTAL][DB.Metric.TOTAL] = damage
    pet[index][pet_name][DB.Enum.Trackable.TOTAL_NO_SC] = T{}
    pet[index][pet_name][DB.Enum.Trackable.TOTAL_NO_SC][DB.Metric.TOTAL] = damage
...
Debug.Unit.Tests.Melee.Pet_Shadows = function()
    ...
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.SHADOW_ABSORPTION] = 1
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE] = T{}
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.SHADOW_ABSORPTION] = 1
    ...
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.ATTEMPTS] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.HIT_COUNT] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.SHADOW_ABSORPTION] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE] = T{}
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.ATTEMPTS] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.HIT_COUNT] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.SHADOW_ABSORPTION] = 1
...
Debug.Unit.Tests.Melee.Pet_Mob_Heal = function()
    ...
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.PET_MELEE][DB.Metric.MOB_HEALING] = damage
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE] = T{}
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.MOB_HEALING] = damage
    ...
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.ATTEMPTS] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.HIT_COUNT] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE][DB.Metric.MOB_HEALING] = damage
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE] = T{}
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.ATTEMPTS] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.HIT_COUNT] = 1
    pet[index][pet_name][DB.Enum.Trackable.PET_MELEE_DISCRETE][DB.Metric.MOB_HEALING] = damage
...
Debug.Unit.Tests.Melee.Daken_Hit = function()
    ...
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.MIN] = damage
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.MAX] = damage
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.MULTI_ATTACK_1] = 1
    player[index][DB.Enum.Trackable.TOTAL] = T{}
    player[index][DB.Enum.Trackable.TOTAL][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.TOTAL_NO_SC] = T{}
    player[index][DB.Enum.Trackable.TOTAL_NO_SC][DB.Metric.TOTAL] = damage
...
Debug.Unit.Tests.Melee.Daken_Crit = function()
    ...
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.CRITICAL_DAMAGE] = damage
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.CRITICAL_COUNT] = 1
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.THROWING][DB.Metric.MULTI_ATTACK_1] = 1
    player[index][DB.Enum.Trackable.TOTAL] = T{}
    player[index][DB.Enum.Trackable.TOTAL][DB.Metric.TOTAL] = damage
...
Debug.Unit.Tests.Melee.Kick_Hit = function()
    ...
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.MIN] = damage
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.MAX] = damage
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.MULTI_ATTACK_1] = 1
    player[index][DB.Enum.Trackable.MELEE_COUNTERED] = T{}
    player[index][DB.Enum.Trackable.MELEE_COUNTERED][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.TOTAL] = T{}
    player[index][DB.Enum.Trackable.TOTAL][DB.Metric.TOTAL] = damage
...
Debug.Unit.Tests.Melee.Kick_Crit = function()
    ...
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.MIN] = damage
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.MAX] = damage
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.CRITICAL_DAMAGE] = damage
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.CRITICAL_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.ATTEMPTS] = 1
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.MELEE_STRIKES] = 1
    player[index][DB.Enum.Trackable.MELEE_KICK][DB.Metric.MULTI_ATTACK_1] = 1
...
Debug.Unit.Tests.Melee.Endamage = function()
    ...
    player[index][DB.Enum.Trackable.ENDAMAGE][DB.Metric.TOTAL] = additional_damage
    player[index][DB.Enum.Trackable.ENDAMAGE][DB.Metric.MIN] = additional_damage
    player[index][DB.Enum.Trackable.ENDAMAGE][DB.Metric.MAX] = additional_damage
    player[index][DB.Enum.Trackable.ENDAMAGE][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.TOTAL] = T{}
    player[index][DB.Enum.Trackable.TOTAL][DB.Metric.TOTAL] = damage + additional_damage
    player[index][DB.Enum.Trackable.TOTAL_NO_SC] = T{}
    player[index][DB.Enum.Trackable.TOTAL_NO_SC][DB.Metric.TOTAL] = damage + additional_damage
    ...
    player_catalog[index][add_effect_name][DB.Enum.Trackable.ENDAMAGE][DB.Metric.TOTAL] = additional_damage
    player_catalog[index][add_effect_name][DB.Enum.Trackable.ENDAMAGE][DB.Metric.MIN] = additional_damage
    player_catalog[index][add_effect_name][DB.Enum.Trackable.ENDAMAGE][DB.Metric.MAX] = additional_damage
    player_catalog[index][add_effect_name][DB.Enum.Trackable.ENDAMAGE][DB.Metric.HIT_COUNT] = 1
...
Debug.Unit.Tests.Melee.Endebuff = function()
    ...
    player[index][DB.Enum.Trackable.ENDEBUFF][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.TOTAL] = T{}
    player[index][DB.Enum.Trackable.TOTAL][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.TOTAL_NO_SC] = T{}
    player[index][DB.Enum.Trackable.TOTAL_NO_SC][DB.Metric.TOTAL] = damage
    ...
    player_catalog[index][add_effect_name][DB.Enum.Trackable.ENDEBUFF][DB.Metric.HIT_COUNT] = 1
...
Debug.Unit.Tests.Melee.Endrain = function()
    ...
    player[index][DB.Enum.Trackable.ENDRAIN][DB.Metric.TOTAL] = additional_damage
    player[index][DB.Enum.Trackable.ENDRAIN][DB.Metric.HIT_COUNT] = 1
    player[index][DB.Enum.Trackable.TOTAL] = T{}
    player[index][DB.Enum.Trackable.TOTAL][DB.Metric.TOTAL] = damage
    player[index][DB.Enum.Trackable.TOTAL_NO_SC] = T{}
    player[index][DB.Enum.Trackable.TOTAL_NO_SC][DB.Metric.TOTAL] = damage
...
Debug.Unit.Tests.Melee.Enaspir = function()
    ...
    player[index][DB.Enum.Trackable.ENASPIR][DB.Metric.TOTAL] = additional_damage
    player[index][DB.Enum.Trackable.ENASPIR][DB.Metric.HIT_COUNT] = 1
