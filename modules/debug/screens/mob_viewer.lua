...
Debug.Mob.Rows = function(mob)
    ...
    UI.TableNextColumn() UI.Text(string.format("%.1f",(Ashita.Mob.Distance(Ashita.Mob.GetMobByTarget(Ashita.TargetString.ME), mob))))
    UI.TableNextRow()
    UI.TableNextColumn() UI.Text("hpp")
    UI.TableNextColumn() UI.Text(tostring(mob.hpp))
    UI.TableNextRow()
    UI.TableNextColumn() UI.Text("x")
    UI.TableNextColumn() UI.Text(Column.String.FormatNumber(mob.x))
    UI.TableNextRow()
    UI.TableNextColumn() UI.Text("y")
    UI.TableNextColumn() UI.Text(Column.String.FormatNumber(mob.y))
    UI.TableNextRow()
    UI.TableNextColumn() UI.Text("z")
    UI.TableNextColumn() UI.Text(Column.String.FormatNumber(mob.z))
    UI.TableNextRow()
    UI.TableNextColumn() UI.Text("rotation")
    UI.TableNextColumn() UI.Text(Column.String.FormatNumber(mob.rotation_deg))
    UI.TableNextRow()
