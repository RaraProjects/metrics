...
require("modules.debug.tests.abilities")
require("modules.debug.tests.defense")
require("modules.debug.tests.melee")
require("modules.debug.tests.ranged")
require("modules.debug.tests.spells")
require("modules.debug.tests.tp_action")
...
Debug.Unit.Populate = function()
    ...
    if UI.BeginTable("Unit Tests", 4) then
        UI.TableSetupColumn("Test",          colFlags)
        UI.TableSetupColumn("Result",        colFlags)
        UI.TableSetupColumn("Errors",        colFlags)
        UI.TableSetupColumn("Error Message", colFlags)
        UI.TableHeadersRow()
...
Debug.Unit.RunTests = function()
    ...
    table.insert(Debug.Unit.Results, Debug.Unit.Tests.Spells.AbsorbTP())
